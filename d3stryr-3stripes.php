...
//      }
        ...
        if (d3stripesLocaleDefault == "") {
          setCookie("d3stripesLocaleDefault", "No", 365);
        }
  ...
  <?php
    ...
    for ($x = 530; $x <= 810; $x=$x+10)
    {
      ...
      array_push($sizes, 210);
      $readableSizes[210]="2K";
      array_push($sizes, 220);
      $readableSizes[220]="3K";
      array_push($sizes, 230);
      $readableSizes[230]="4K";
      array_push($sizes, 240);
      $readableSizes[240]="5K";
      array_push($sizes, 250);
      $readableSizes[250]="5.5K";
      array_push($sizes, 260);
      $readableSizes[260]="6K";
      array_push($sizes, 270);
      $readableSizes[270]="6.5K";
      array_push($sizes, 280);
      $readableSizes[280]="7K";
      array_push($sizes, 290);
      $readableSizes[290]="7.5K";
      array_push($sizes, 310);
      $readableSizes[310]="8K";
      array_push($sizes, 320);
      $readableSizes[320]="8.5K";
      array_push($sizes, 330);
      $readableSizes[330]="9K";
      array_push($sizes, 340);
      $readableSizes[340]="9.5K";
      array_push($sizes, 350);
      $readableSizes[350]="10K";
...
//    echo"                  <textarea name='gcaptcha' id='gcaptcha' cols='50' rows='5'>" . $gcaptcha . "</textarea>"."\n";
      ...
      echo"            <th id='headers'>Size<br>(630=9 US)<br>(350=10K US)</th>"."\n";
      echo"            <th id='headers'>CREATE<br>INJECTION<br>CODE<br>OLD<br>"."\n";
      ...
      echo"            </th>"."\n";
      echo"            <th id='headers'>CREATE<br>INJECTION<br>CODE<br><br>"."\n";
                       if (strlen($gcaptcha)<1)
                       {
      echo"                <br><font color='red'>CAPTCHA<br>UNSOLVED</font>"."\n";
                       }
      ...
      echo"            </th>"."\n";
      echo"            <th id='headers'>CREATE<br>INJECTION<br>CODE<br>+CAP DUP<br>"."\n";
                       if (strlen($gcaptcha)<1)
                       {
      echo"                <br><font color='red'>CAPTCHA<br>UNSOLVED</font>"."\n";
                       }
      ...
      echo"            </th>"."\n";
      echo"            <th id='headers'>CREATE<br>INJECTION<br>CODE<br>+CAP DUP<br>+CLIENTID"."\n";
                       if (strlen($gcaptcha)<1)
                       {
      echo"                <br><font color='red'>CAPTCHA<br>UNSOLVED</font>"."\n";
                       }
      ...
      echo"            </th>"."\n";
      echo"            <th id='headers'>ATC<br>FORM<br>POST<br><br>"."\n";
                       if (strlen($gcaptcha)<1)
                       {
      echo"                <br><font color='red'>CAPTCHA<br>UNSOLVED</font>"."\n";
                       }
      ...
      echo"            </th>"."\n";
      echo"            <th id='headers'>ATC<br>FORM<br>POST<br>+CAP DUP<br>"."\n";
                       if (strlen($gcaptcha)<1)
                       {
      echo"                <br><font color='red'>CAPTCHA<br>UNSOLVED</font>"."\n";
                       }
      ...
      echo"            </th>"."\n";
      echo"            <th id='headers'>ATC<br>FORM<br>POST<br>+CAP DUP<br>+CLIENTID"."\n";
                       if (strlen($gcaptcha)<1)
                       {
      echo"                <br><font color='red'>CAPTCHA<br>UNSOLVED</font>"."\n";
                       }
      ...
      echo"                <td><center><b><font color='red'>" . @$clientCount[$pid] . "</font></b></center></td>"."\n";
                      ...
                      {
      echo"            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='blue'>" . $size . "</font></td>"."\n";
                      }
                      else
                      {
      echo"            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $size . "</td>"."\n";
      ...
      echo"            <form id='injectionThatShouldHaveBeenBlocked' action='".$atcURL."' method='post' target='_blank'>"."\n";
//    echo"            <form id='injectionThatShouldHaveBeenBlocked' action='".$atcURL."' method='post' target='_self'>"."\n";
      echo"            <td>"."\n";
      if (isset($gcaptcha))
      {
      ...
      echo"              <center><button name='add-to-cart-button'><span>INJCTN</button></center>"."\n";
      echo"            </td>"."\n";
      echo"            </form>"."\n";

      echo"            <form id='injection' action='".$atcURL."' method='post' target='_blank'>"."\n";
//    echo"            <form id='injection' action='".$atcURL."' method='post' target='_self'>"."\n";
      echo"            <td>"."\n";
      if (isset($gcaptcha))
      {
        if (strlen($gcaptcha) > 50)
      ...
      echo"            <form id='injectionCaptchaDuplicate' action='".$atcURL."' method='post' target='_blank'>"."\n";
//    echo"            <form id='injectionCaptchaDuplicate' action='".$atcURL."' method='post' target='_self'>"."\n";
      echo"            <td>"."\n";
      if (isset($gcaptcha))
      {
        if (strlen($gcaptcha) > 50)
      ...
      echo"            <form id='injectionCaptchaDuplicateClientId' action='".$atcURL."' method='post' target='_blank'>"."\n";
//    echo"            <form id='injectionCaptchaDuplicateClientId' action='".$atcURL."' method='post' target='_self'>"."\n";
      echo"            <td>"."\n";
      if (isset($gcaptcha))
      {
        if (strlen($gcaptcha) > 50)
      ...
      echo"            <form id='notify' action='".$atcURL."' method='post' target='_blank'>"."\n";
//    echo"            <form id='notify' action='".$atcURL."' method='post' target='_self'>"."\n";
      echo"            <td>"."\n";
      if (isset($gcaptcha))
      {
        if (strlen($gcaptcha) > 50)
      ...
      echo"              <center><button name='add-to-cart-button'><span>Add To Bag</span></button></center>"."\n";
      echo"            </td>"."\n";
      echo"            </form>"."\n";
...
//    echo"            <form id='notify' action='".$atcURL."' method='post' target='_self'>"."\n";
      ...
      echo"              <input type='hidden' name='pid' class='product_id' value='".$pid."'>"."\n";
      echo"              <input type='hidden' name='Quantity' value='1'>"."\n";
      echo"              <input type='hidden' name='request' value='ajax'>"."\n";
      echo"              <input type='hidden' name='responseformat' value='json'>"."\n";
      echo"              <input type='hidden' name='sessionSelectedStoreID' value='null'>"."\n";
...
/* SCRIPT TO REMIND USER TO SOLVE A NEW CAPTCHA */
...
/* SCRIPT TO TO CREATE INJECTION CODE OLD APPROACH THAT SHOULDNT WORK BUT DID ON THE V2 DROP */

      echo'      <script>
            $("form#injectionThatShouldHaveBeenBlocked").submit(function(event) {
      ...
      if (isset($gcaptcha))
      {
        ...
        {
          echo '
          f.setAttribute("action","'.$atcURL.'?pid=`+dataArray["pid"]+`&masterPid=`+dataArray["masterPid"]+`&ajax=true&g-recaptcha-response=`+dataArray["g-recaptcha-response"]+`");
          ';
        }
        else
        {
          echo '
          f.setAttribute("action","'.$atcURL.'?pid=`+dataArray["pid"]+`&masterPid=`+dataArray["masterPid"]+`&ajax=true");
          ';
        }
      }
      ...
      echo '
                    $("textarea#inject").val(injectText);
                    $("textarea#gcaptcha").val("Token used. Solve another CAPTCHA");
                  });
                 </script>';

/* SCRIPT TO TO CREATE INJECTION CODE */
      ...
      echo'      <script>
          ...
          responseOption.setAttribute("name","layer");
      ...
      if (isset($gcaptcha))
      {
        if (strlen($gcaptcha) > 50)
        {
          ...
          captchaToken.setAttribute("value","'.$gcaptcha.'");
...
/* SCRIPT TO TO CREATE INJECTION CODE W/ CAPTCHA DUPLICATE*/

      echo'      <script>
            $("form#injectionCaptchaDuplicate").submit(function(event) {
              event.preventDefault();
              var objArray=$(event.target).serializeArray();
              var dataArray={};
              for (var i = 0, l = objArray.length; i < l; i++) {
      ...
      if (isset($gcaptcha))
      {
        if (strlen($gcaptcha) > 50)
        {
          ...
          captchaDuplicate.setAttribute("name","'.$duplicate.'");
          captchaDuplicate.setAttribute("value","'.$gcaptcha.'");
...
/* SCRIPT TO TO CREATE INJECTION CODE W/ CAPTCHA DUPLICATE AND CLIENT ID*/

      echo'      <script>
            $("form#injectionCaptchaDuplicateClientId").submit(function(event) {
              event.preventDefault();
              var objArray=$(event.target).serializeArray();
              var dataArray={};
              for (var i = 0, l = objArray.length; i < l; i++) {
          ...
          f.setAttribute("id","destroyer");
          f.setAttribute("method","post");
          f.setAttribute("action","'.$atcURL."?clientId=".$clientId.'");
  ...
  <body onload="checkCookie()">
    <?php
      ...
      //Locale is obtained from cookies
      @$localeDefault=$_COOKIE['d3stripesLocaleDefault'];
      //Curl Timeout
    ...
    <?php if ( (isset($_POST['gotoPage'])) && (@$_POST['gotoPage'] == 'loadInventoryPage')): ?>
      ...
      <?php
        ...
        if ($localeDefault == "Yes")
        {
          $marketsList[$locale]="default";
        }
      ...
      <form action="<?php echo $actionURL; ?>" method="post">
        ...
        <table>
          ...
          <tr>
            ...
            <td valign="middle">
              <select id="locale" name="d3stripesLocale">
...
<!--            <option value="CF">CA (Canada-French)</option> -->
          ...
          <script>
            ...
            SelectElement("<?php echo $_COOKIE["d3stripesLocale"]; ?>");
          </script>
          <tr>
            <td id="headers"><p>Locale: Default </p></td>
            <td valign="middle">
              <select name="d3stripesLocaleDefault">
                <?php if ($_COOKIE["d3stripesLocaleDefault"] == "Yes"): ?>
          ...
          <tr>
            ...
            <td>
              <textarea name='setcookie' id='setcookie' cols='50' rows='2'>HRPYYU=true;</textarea>
            </td>
          </tr>
          <tr>
          <tr>
...
'><font color="orange">Injection</font></a> Usage (Click bookmarklet. Paste injection code.)</p>
    ...
    <?php else: ?> <!-- Load the main page -->
      <?php if ( (isset($_POST['gotoPage'])) && (@$_POST['gotoPage'] == 'changeParameters')): ?>
        ...
        <script>
          ...
          setCookie("d3stripesLocaleDefault", "<?php echo $_POST["d3stripesLocaleDefault"]; ?>", 365);
        ...
        <?php
          ...
          //Use default locale
          @$_COOKIE['d3stripesLocaleDefault']=$_POST['d3stripesLocaleDefault'];
        ...
        <tr>
          <td valign="top">
            ...
            <fieldset>
              ...
              <li>Be sure to use the appropriate Client ID and Site Key for your locale.</li>
              </ul>
              </p>
            </fieldset>
          </td>
